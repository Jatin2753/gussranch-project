    ...
    <body class="cbp-spmenu-push">
        <div class="main-content">
            ...
            <div id="page-wrapper">
                <div class="main-page">
                    <div class="forms">
                        <h2 class="title1">View All Orders</h2>
                        <div class="form-group col-lg-12 ">
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <%
                                           ResultSet rs= microvision.DataUtility.executeDQL("SELECT  *FROM tblorders INNER JOIN tbluser ON tblorders.userid=tbluser.id WHERE orderstatus='delivered' ORDER BY orderno DESC");
