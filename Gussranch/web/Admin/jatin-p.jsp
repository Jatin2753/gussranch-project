                            ...
                            <div class="form-body">
                                ...
                                <form method="post" action="sub-category-add.jsp">
                                    ...
                                    <div class="form-group col-lg-12">
                                        ...
                                        <input type="text" name="subcatdesc" required=""  class="form-control" placeholder="Sub Category description" />
                                    </div>
                                ...
                                <div class="form-group col-lg-12 ">
                                    ...
                                    <%    if (request.getParameter("subcatname") != null) {
                                            ...
                                            if (r > 0) {
                                                ...
                                                out.print("<span class='alert alert-danger'>Data Process not!!</span>");
                                            }
                                        }
                                ...
                                <div class="form-group col-lg-12">
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <%  ResultSet rs1 = microvision.DataUtility.executeDQL("SELECT tblcategory.categoryname,tblSubCategory.* FROM tblsubcategory INNER JOIN tblcategory ON tblcategory.id=tblSubCategory.catid ORDER BY id DESC ");
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="category-edit.jsp?catedit=<% out.print(rs1.getString(1)); %>" class="btn btn-warning">Edit</a>
                                                <a href="category-edit.jsp?catdel=<% out.print(rs1.getString(1)); %>" class="btn btn-danger">Delete</a>
                                            </td>
                                        </tr>
                                        <%
                                            }
