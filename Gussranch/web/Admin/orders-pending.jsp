                    ...
                    <div class="forms">
                        ...
                        <div class="form-group col-lg-12 ">
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <%
                                           ResultSet rs= microvision.DataUtility.executeDQL("SELECT  *FROM tblorders INNER JOIN tbluser ON tblorders.userid=tbluser.id WHERE orderstatus='pending' ORDER BY orderno DESC");
