...
<html>
    <head>
        <title>Sales Current Year </title>
    ...
    <body class="cbp-spmenu-push">
        <div class="main-content">
            ...
            <div id="page-wrapper">
                <div class="main-page">
                    <div class="forms">
                        <h2 class="title1">Sales Current Year</h2>
                        <div class="form-group col-lg-12 ">
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <%
                                           ResultSet rs= microvision.DataUtility.executeDQL("SELECT  *FROM tblorders INNER JOIN tbluser ON tblorders.userid=tbluser.id WHERE YEAR(tblorders.dateon) = YEAR(CURRENT_DATE())");
                                           stotal=0;
                                           while(rs.next())
                                           {
